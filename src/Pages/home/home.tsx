...
const Home = () => {
  ...
  return (
    <div className="h-full bg-[#141414] flex text-white justify-center flex-col -mt-12">
      <HeaderNetflix />
      <div className="relative">
        ...
        />
        <div className="absolute z-50 h-full w-full bg-gradient-to-t from-[#141414] to-transparent top-0">
          {" "}
        </div>
      </div>
      <div className="flex w-full overflow-hidden pl-14 flex-col ">
        <div className="flex w-full flex-col">
          <h1 className="text-lg font-medium">Top Search</h1>
          <CarouselMovies movies={topSearch} className="w-screen" />
        </div>
        <div className="flex w-full flex-col">
          {Boolean(favorites.length) && (
            <>
              <h1 className="text-lg font-medium">My List</h1>
              <CarouselMovies
                movies={favorites}
                className="w-screen"
              ></CarouselMovies>
        ...
        <div className="flex w-full flex-col">
          <h1 className="text-lg font-medium">Popular Series</h1>
