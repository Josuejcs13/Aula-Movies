...
import netflixChicken from "../../assets/netflix-chicken.png";
...
function HeaderNetflix() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full h-16 bg-gradient-to-b from-black/85 to-transparent transition-all duration-700 flex justify-between px-14 text-white z-50 ${
